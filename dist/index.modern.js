...
const FooterIconButtons = styled.div(_t4$1 || (_t4$1 = _$3`
  white-space: nowrap;
  padding: 0 10px;
...
const MenuWrapper = styled.ul(_t$4 || (_t$4 = _$4`
  display: flex;
...
`));
const MenuItem = styled.a(_t2$3 || (_t2$3 = _$4`
  z-index: 1;
  position: relative;
  font-size: 16px;
...
`), ({
  ...
  selected
    ...
    font-weight: bold;
  `);
const SelectedCircle = styled.span(_t3$2 || (_t3$2 = _$4`
  z-index: -1;
  position: absolute;
  top: -3px;
  right: -5px;
...
let _$5 = t => t,
    ...
    _t3$3,
    _t4$2;
const HeaderNav = styled.div(_t$5 || (_t$5 = _$5`
  padding: 0 30px;
  width: 100%;
  height: 40px;
  display: flex;
...
const HeaderNavItem = styled.li(_t2$4 || (_t2$4 = _$5`
  width: 80px;
  height: 100%;
  list-style: none;
  text-align: center;
...
`), ({
  ...
  ` : "");
const HeaderMenu = styled.div(_t3$3 || (_t3$3 = _$5`
  padding: 0 42px;
  width: 100%;
  height: 100px;
  display: flex;
