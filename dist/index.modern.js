...
const FooterInfo = styled.div(_t2$4 || (_t2$4 = _$7`
  border-right: 1px solid ${0};
  height: 100%;
  box-sizing: border-box;
  font-size: 11px;
...
const FooterButton = styled.button(_t3$2 || (_t3$2 = _$7`
  ${0}
  padding: 12px 10px;
  color: ${0};
  background-color: ${0};
...
const FooterIconButtons = styled.div(_t4$2 || (_t4$2 = _$7`
  white-space: nowrap;
  padding: 0 10px;
...
const MenuWrapper = styled.ul(_t$8 || (_t$8 = _$8`
  display: flex;
...
`));
const MenuItem = styled.a(_t2$5 || (_t2$5 = _$8`
  z-index: 1;
  position: relative;
  font-size: 16px;
  text-decoration: none;
...
`), ({
  ...
  selected
    ...
    font-weight: bold;
  `);
const SelectedCircle = styled.span(_t3$3 || (_t3$3 = _$8`
  z-index: -1;
  position: absolute;
  top: -3px;
  right: -5px;
...
let _$9 = t => t,
    ...
    _t3$4,
    _t4$3;
const HeaderNav = styled.div(_t$9 || (_t$9 = _$9`
  padding: 0 30px;
  width: 100%;
  height: 40px;
  display: flex;
...
const HeaderNavItem = styled.li(_t2$6 || (_t2$6 = _$9`
  width: 80px;
  height: 100%;
  list-style: none;
  text-align: center;
...
`), ({
  ...
  ` : "");
const HeaderMenu = styled.div(_t3$4 || (_t3$4 = _$9`
  padding: 0 42px;
  width: 100%;
  height: 100px;
  display: flex;
...
const Header = styled(({
  ...
  href: to
}, label)))), React.createElement("ul", null, isLoggedIn ? rightLoggedInMenus.map(({
  label,
  to
}) => React.createElement(HeaderNavItem, {
  key: `header-nav-${label}`,
...
const Wrapper = styled.div(_t$a || (_t$a = _$a`
  display: flex;
  min-height: 100vh;
  flex-direction: column;
`));
const Main = styled.main(_t2$7 || (_t2$7 = _$a`
  flex: 1;
`));
const PageBody = styled.div(_t3$5 || (_t3$5 = _$a`
  width: 700px;
  max-width: 100%;
  margin: 0 auto;
`));
...
const Column = styled.div(_t4$4 || (_t4$4 = _$a`
  width: 100%;
  display: flex;
  flex-direction: column;
  justify-content: ${0};
...
const Row = styled.div(_t5 || (_t5 = _$a`
  width: 100%;
  display: flex;
  flex-direction: row;
  justify-content: ${0};
...
const MessageBox = styled.div(_t$b || (_t$b = _$b`
  border: 1px solid ${0};
