...
export declare const Typography: import("styled-components").StyledComponent<({ color, variant, textAlign, className, children, ...rest }: TypographyProps) => JSX.Element, any, {}, never>;
